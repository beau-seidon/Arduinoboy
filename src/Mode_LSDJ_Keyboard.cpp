                ...
                */
                ...
                switch (incomingMidiByte & 0xF0) {
                    ...
                    case 0xC0:
                        ...
                        break;
                    case 0xF0:
                        // Do nothing, these dont innerfear with our note-on mode
                        break;
                    default:
...
void playLSDJNote(byte channel, byte note, byte velocity)
{
    if (channel == (0x90 + memory[MEM_KEYBD_CH]) && velocity > 0x00) {    // If midi channel = ours and the velocity is greater then 0
